<?php 
 ...
 if (isset($_POST['pexpenses'])) {
  ...
  $sql = "INSERT INTO pmaintenance (requestees,branch,printer,request_date,technician,cost) VALUES('$requestees','$branch','$printer','$request_date','$technician',$cost)";
   mysqli_query($db, $sql);
  if ($sql) {
    # code...
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
             <h1 class="h3 mb-0 text-gray-800">Printer Expenses Information</h1>
      ...
      <form class="needs-validation" novalidate method="post" action="" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <hr class="mb-4">
        <button class="btn btn-primary btn-lg btn-signup" name="pexpenses" type="submit">Submit Data</button>
      </form>
        <!-- /.container-fluid -->
