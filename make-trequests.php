<?php 
  ...
  $sql = "INSERT INTO tonners (requestees,branch,tonner,request_date,quantity,price) VALUES('$requestees','$branch','$tonner','$request_date',$quantity,$price)";
   mysqli_query($db, $sql);
  if ($sql) {
    # code...
...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Printers' Components:</h6>
            <a class="collapse-item" href="make-prequests.php">Printer's Requested</a>
            <a class="collapse-item" href="view-papproved.php">Printer's Approved</a>
            <a class="collapse-item" href="view-pissued.php">Printer's Issued</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Tonner Components:</h6>
            <a class="collapse-item" href="make-trequests.php">Tonner's Requested</a>
            <a class="collapse-item" href="view-tapproved.php">Tonner's Approved</a>
            <a class="collapse-item" href="view-tissued.php">Tonner's Issued</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapse" class="collapse" aria-labelledby="heading" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Maintenance Components:</h6>
            <a class="collapse-item" href="make-pexpenses.php">Printers's Expenses</a>
            <a class="collapse-item" href="make-texpenses.php">Tonner's Expenses</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="dashboard.php?logout='1'" data-toggle="modal" data-target="#logoutModal">
        ...
        <div class="container-fluid">
         ...
         <div class="d-sm-flex align-items-center justify-content-between mb-4">
             <h1 class="h3 mb-0 text-gray-800">Tonners Request Information</h1>
             <a href="view-trequests.php" class="loginhere-link"><h1 class="h3 mb-0 text-gray-800">View Tonner Request</h1></a>
        ...
        <div class="mb-3">
          <label>Tonner Type</label>
          <input type="text" class="form-control" name="tonner" placeholder="Type the name of the Tonner" required>
          <div class="invalid-feedback">
                  Valid Tonner name is required.
          </div> 
        </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" name="quantity" placeholder="Enter No of Tonners requested"  required>
            <div class="invalid-feedback">
                  Valid number of tonners is required.
            </div> 
          </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">
                  Valid price tag is required.
            </div> 
          </div>
        </div>

          <hr class="mb-4">
        <button class="btn btn-primary btn-lg btn-signup" name="trequests" type="submit">Submit Request</button>
      </form>
  ...
  <script>window.jQuery || document.write('<script src="assets/vendor/jquery/jquery.slim.min.js"><\/script>')</script>
  <script src="assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
