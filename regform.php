	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" method="post" action="regform.php">
					...
					<div class="flex-sb-m w-full p-b-48">
						<div class="contact100-form-checkbox">
							<label class="label">
								<p>Already have an account?<a href="index.php" class="loginhere-link">Click here to Log in.</a> </p>
							</label>
						</div>
