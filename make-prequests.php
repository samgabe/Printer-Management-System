<?php 
  ...
  $sql = "INSERT INTO printers (requestees,branch,printer,request_date,quantity,price) VALUES ('$requestees','$branch','$printer','$request_date',$quantity,$price)";
   mysqli_query($db, $sql);
  if ($sql) {
    # code...
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="view-trequests.php">Tonner's Approved</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
             <h1 class="h3 mb-0 text-gray-800">Printer Request Information</h1>
             <a href="view-prequests.php" class="loginhere-link"><h1 class="h3 mb-0 text-gray-800">View Printer Request</h1></a>
      ...
      <form class="needs-validation" novalidate method="post" action="" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">
                  Valid number of printers is required.
            </div> 
          </div>
          ...
          <hr class="mb-4">
        <button class="btn btn-primary btn-lg btn-signup" name="prequests" type="submit">Submit Request</button>
      </form>
        <!-- /.container-fluid -->
